...
export default function Home(): JSX.Element {
  ...
  return (
    <>
      ...
      <Box maxW={1120} px={20} mx="auto" my={20} textAlign="center">
        <CardList cards={formattedData} />
        {/* TODO RENDER LOAD MORE BUTTON IF DATA HAS NEXT PAGE */
          hasNextPage && (
            isFetchingNextPage ?
              <Button size="lg" fontSize="md" mt="2rem">Carregando...</Button>
              :
              <Button size="lg" fontSize="md" mt="2rem" onClick={() => fetchNextPage()}>Carregar mais</Button>
          )
        }
      </Box>
    </>
